(() => {
	...
	const    sigils      = document.querySelectorAll('.sigil-container'),
			 ...
			 lbPlay      = document.querySelector('.lightbox-play');
			 lbPause     = document.querySelector('.lightbox-pause');
	...
	[`TYREEL`,`House Tyrell of Highgarden is an extinct Great House of Westeros. It ruled over the Reach, 
	a vast, fertile, and heavily-populated region of southwestern Westeros, from their castle-seat of Highgarden
	 as Lords Paramount of the Reach and Wardens of the South after taking control of the region from House Gardener 
	 during the Targaryen conquest. `],
	...
	lbPause.addEventListener('click',pauseVideo);
